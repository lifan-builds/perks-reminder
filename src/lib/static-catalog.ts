...
export const STATIC_CATALOG_UPDATED_AT = '2026-09-20';
...
export const predefinedCardsData = [
    ...
    {
      catalogKey: 'card:southwest-performance-business',
      ...
      benefits: [
        {
          ...
          parentCatalogKey: 'card:southwest-performance-business',
          description: '9,000 anniversary points',
          category: 'Bonus',
          maxAmount: 0,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:southwest-performance-business:120-global-entry-tsa-precheck-or-nexus-credit-every-4-years',
          parentCatalogKey: 'card:southwest-performance-business',
          description: '$120 Global Entry, TSA PreCheck, or NEXUS Credit (every 4 years)',
          category: 'Travel',
          maxAmount: 120,
        ...
        {
          catalogKey: 'benefit:southwest-performance-business:10000-companion-pass-qualifying-points',
          parentCatalogKey: 'card:southwest-performance-business',
          description: '10,000 Companion Pass qualifying points',
          category: 'Bonus',
          maxAmount: 0,
          frequency: 'YEARLY',
          percentage: 0,
    ...
    {
      catalogKey: 'card:sapphire-reserve-business',
      ...
      benefits: [
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:250-select-chase-travel-hotel-credit-through-2026-12-31',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$250 Select Chase Travel Hotel Credit (prepaid 2+ nights; through 12/31/2026)',
          category: 'Travel',
          maxAmount: 250,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:500-the-edit-credit',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$500 Annual The Edit Credit (prepaid 2+ nights; up to $250 per transaction)',
          category: 'Travel',
          maxAmount: 500,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:120-global-entry-tsa-precheck-or-nexus-credit-every-4-years',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$120 Global Entry, TSA PreCheck, or NEXUS Credit (every 4 years)',
          category: 'Travel',
          maxAmount: 120,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:200-annual-google-workspace-credit',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$200 Annual Google Workspace Credit (direct purchases; through 12/31/2027)',
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:200-ziprecruiter-credit-jan-jun',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$200 ZipRecruiter Credit (Jan-Jun; through 12/31/2027)',
          category: 'Business Services',
          maxAmount: 200,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:200-ziprecruiter-credit-jul-dec',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$200 ZipRecruiter Credit (Jul-Dec; through 12/31/2027)',
          category: 'Business Services',
          maxAmount: 200,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:10-monthly-lyft-credit',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$10 Monthly Lyft Credit (through 9/30/2027)',
          category: 'Transportation',
          maxAmount: 10,
          frequency: 'MONTHLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:sapphire-reserve-business:25-monthly-doordash-promos',
          parentCatalogKey: 'card:sapphire-reserve-business',
          description: '$25 Monthly DoorDash Promos ($5 restaurant + two $10 non-restaurant; DashPass required; through 12/31/2027)',
          category: 'Food Delivery',
          maxAmount: 25,
          frequency: 'MONTHLY',
          percentage: 0,
    ...
    {
      catalogKey: 'card:citi-aadvantage-mileup',
    ...
    {
      catalogKey: 'card:citi-aadvantage-platinum-select',
    ...
    {
      catalogKey: 'card:citi-aadvantage-executive',
      ...
      benefits: [
        {
          ...
          parentCatalogKey: 'card:citi-aadvantage-executive',
    ...
    {
      catalogKey: 'card:citi-aadvantage-business',
      ...
      benefits: [
        {
          ...
          parentCatalogKey: 'card:citi-aadvantage-business',
          description: 'American Airlines Companion Certificate after $30,000 cardmembership-year spend and renewal ($99 plus taxes/fees)',
          category: 'Travel',
          maxAmount: 0,
          frequency: 'YEARLY',
          percentage: 0,
    ...
    {
      catalogKey: 'card:citi-aadvantage-globe',
      ...
      benefits: [
        {
          ...
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: '4 Admirals Club Globe Passes (calendar year)',
          category: 'Travel',
          maxAmount: 0,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:citi-aadvantage-globe:240-annual-turo-credit',
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: '$240 Annual Turo Credit (up to $30 per completed trip; link card at Turo.com/Globe)',
          category: 'Transportation',
          maxAmount: 240,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:citi-aadvantage-globe:100-annual-inflight-credit',
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: '$100 Annual American Airlines Inflight Credit',
          category: 'Travel',
          maxAmount: 100,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:citi-aadvantage-globe:100-annual-splurge-credit',
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: '$100 Annual Splurge Credit (select brands)',
          category: 'Shopping',
          maxAmount: 100,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:citi-aadvantage-globe:annual-companion-certificate',
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: 'American Airlines Companion Certificate on renewal from year two ($99 plus taxes/fees)',
          category: 'Travel',
          maxAmount: 0,
          frequency: 'YEARLY',
          percentage: 0,
        ...
        {
          catalogKey: 'benefit:citi-aadvantage-globe:120-global-entry-or-tsa-precheck-credit-every-4-years',
          parentCatalogKey: 'card:citi-aadvantage-globe',
          description: '$120 Global Entry or TSA PreCheck Credit (every 4 years)',
          category: 'Travel',
          maxAmount: 120,
...
export function calculateAnnualBenefitValue(
  maxAmount: number | null | undefined,
  frequency: StaticBenefitFrequency,
  fixedCycleDurationMonths?: number | null,
): number {
  if (!maxAmount) return 0;
  // YEARLY also represents multi-year credits. Seasonal rows shorter than a
  // year are separate definitions, so their values must not be multiplied.
  if (frequency === 'YEARLY' && fixedCycleDurationMonths && fixedCycleDurationMonths > 12) {
    return maxAmount * 12 / fixedCycleDurationMonths;
  }
