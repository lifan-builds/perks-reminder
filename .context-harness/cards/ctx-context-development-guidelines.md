---
id: ctx-context-development-guidelines
kind: context
importance: 0.74
confidence: confirmed
source: CONTEXT.md#development-guidelines
chunk: .context-harness/chunks/ctx-context-development-guidelines.md
tokens_est: 2316
tags: [context, development-guidelines, environment-setup, database-safety-rules, adding-new-credit-cards, updating-existing-card-benefits, adding-how-to-use-guides]
---
...
## Use when
- working on 🔧 development guidelines
